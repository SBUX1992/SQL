...
create table `Product`(
	`proNo`		tinyint auto_increment primary key,
...
insert into `Product` (`Prono`, `proName`, `stock`, `company`) values(5, '죠리퐁', 2200, '크라운');
insert into `Product` values(6, '마라겟트', 3500, 3500, '롯데');
