...
insert into `Department` values(21, '경제학과', '051-510-1011');
...
insert into `Department` values(32, '생명과학학과', '051-510-1032');
insert into `Department` values(40, '기계공학과', '051-510-1040');
insert into `Department` values(41, '전자공학과', '051-510-1011');
insert into `Department` values(42, '컴퓨터공학과', '051-510-1012');
...
#Student
insert into `Student` (`stdNo`, `depNo`, `proNo`, `stdName`, `stdJumin`, `stdHp`, `stdAddr`) 
